...
LoadingJS.prototype = {
	loadBookConfig : function(){
	  ...
	  try{
	  	this.loadingCaption = bookConfig.loadingCaption?bookConfig.loadingCaption:"Carregando";
	  	this.loadingCaptionColor = bookConfig.loadingCaptionColor?bookConfig.loadingCaptionColor:"#000000";
	  	this.loadingBackground = bookConfig.loadingBackground?bookConfig.loadingBackground:"#FFFFFF";
	  	
	  	this.loadingPicture = bookConfig.loadingPicture?bookConfig.loadingPicture:"";
	  	this.hasLoadingPicture = (this.loadingPicture != "");
	  }catch(err){
	  	this.loadingCaption = "Carregando";
	  	this.loadingCaptionColor = "#000000";
